...
JSON_INPUT_FOLDER = os.path.join("data", "mlvu", "jsons")
VIDEO_OUTPUT_FOLDER = os.path.join("data", "mlvu", "videos")
...
def _build_local_video_index(root=VIDEO_OUTPUT_FOLDER):
    index = {}
...
def _find_local_video(target_filename):
    ...
    # Fast-path: file already in the configured local video folder.
    ...
    if _LOCAL_VIDEO_INDEX is None:
        _LOCAL_VIDEO_INDEX = _build_local_video_index(VIDEO_OUTPUT_FOLDER)
